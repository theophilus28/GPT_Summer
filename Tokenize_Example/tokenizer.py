...
def merge(ids, pair, idx):
    #in list of ints(ids) replace occurnces of pair with idx
    newids = []
    i = 0
    while i < len(ids):
...
vocab_size = 276 #final desired vocab size
...
#splits up text to prevent certain merges from ever happening
